...
forvalues s = 1/`nsizes' {
	...
	di as txt _n "=== TAIL power (gap=50 at p=0.05/0.95, discrepant group=2): n0=`n0' n1=`n1' n2=`n2' (total=`ntot') ==="

	simulate p_ks=r(p_ks) p_ad=r(p_ad) p_cvm=r(p_cvm), ///
		reps(`simreps') seed(230`s'): ///
		simreps_tail `n0' `n1' `n2' `ess_ratio' `testreps'
	...
	quietly gen str12 condition = "tail"
...
use `results8', clear
save "E:\ArielStuff\wtd_k_simulations\sim5_3grp.dta", replace
di as txt _n "Saved: E:\ArielStuff\wtd_k_simulations\sim5_3grp.dta"
