...
forvalues c = 1/`ncond' {
	...
	di as txt _n "=== re=0.4, `cond' condition: n0=600 n1=600 n2=800 (total=2000) ==="

	simulate p_ks=r(p_ks) p_ad=r(p_ad) p_cvm=r(p_cvm), ///
		reps(`simreps') seed(140`c'): ///
...
save "E:\ArielStuff\wtd_k_simulations\sim13_3grp.dta", replace
di as txt _n "Saved: E:\ArielStuff\wtd_k_simulations\sim13_3grp.dta"
